...
jQuery.sap.require("sap.ui.demo.util.Controller");

sap.ui.demo.util.Controller.extend("sap.ui.demo.view.Detail", {
	...
	onRouteMatched : function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(jQuery.proxy(function () {
			...
			oIconTabBar.getItems().forEach(function(oItem) {
				oItem.bindElement(sap.ui.demo.util.Formatter.uppercaseFirstChar(oItem.getKey()));
			});
	...
	showEmptyView : function () {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName : "sap.ui.demo.view.NotFound",
			targetViewType : "XML"
		});
	},
